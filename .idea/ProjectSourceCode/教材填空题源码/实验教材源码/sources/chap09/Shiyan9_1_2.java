...
class MainFrame extends JFrame {
    ...
    public MainFrame() {    
        setIconImage(Toolkit.getDefaultToolkit().createImage(MainFrame.class.getResource("horse.png")));
    ...
    void jButton1_actionPerformed(ActionEvent e) {
        if(((JButton)e.getSource()).getText().equals("Start")){
            ...
            pThread1=new 
ProgressThread(this.jProgressBar1,Thread.MAX_PRIORITY);
            pThread1.start();
            ProgressThread pThread2=new 
ProgressThread(this.jProgressBar2,Thread.NORM_PRIORITY);
            pThread2.start();
            ProgressThread pThread3=new 
ProgressThread(this.jProgressBar3,Thread.MIN_PRIORITY);
            pThread3.start();
        }else{
